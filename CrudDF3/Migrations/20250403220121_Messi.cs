    ...
    public partial class Messi : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Permisos",
                columns: new[] { "IdPermiso", "DescripcionPermiso", "EstadoPermiso", "NombrePermiso" },
                values: new object[] { 1, "Ver panel principal", true, "Dashboard_View" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Rol con todos los permisos", true, "Administrador" },
                    { 2, "Rol para personal de recepción", true, "Recepcionista" },
                    { 3, "Rol para clientes del hotel", true, "Cliente" }
                });

            migrationBuilder.InsertData(
                table: "Rol_Permisos",
                columns: new[] { "IdRolPermiso", "IdPermiso", "IdRol" },
                values: new object[] { 1, 1, 1 });

            migrationBuilder.InsertData(
                table: "Usuarios",
                columns: new[] { "IdUsuario", "ApellidoUsuario", "CedulaUsuario", "ContraseñaUsuario", "CorreoUsuario", "Direccion", "EstadoUsuario", "FechaCreacion", "IdRol", "NombreUsuario", "Telefono" },
                values: new object[] { 1, "Sistema", 123456789, "AQAAAAIAAYagAAAAEJmsXGz5yYwXQY5zV7XQY5zV7XQY5zV7XQY5zV7XQY5zV7XQY5zV7XQY5zV7XQ==", "admin@hotel.com", "Dirección admin", true, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, "Admin", "3001234567" });
